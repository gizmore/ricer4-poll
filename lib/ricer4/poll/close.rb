module Ricer4::Plugins::Poll
  class Close < Ricer4::Plugin
    ...
    def execute(question)
      ...
      rply :msg_closed, type:question.type_label, qid:question.id, question:question.text, asker:question.creator.display_name
    end
    ...
    def announce_free_question_closed(question)
      ...
      question.answers.each do |answer|
        content += "<#{answer.user.display_name}>: \"#{answer.option.choice}\"\n"
      end
